...
App.Boot.populateVersionBadge = function() {
  var badge = document.getElementById('versionBadge');
  if (badge) badge.textContent = App.version;
};

if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', App.Boot.populateVersionBadge);
} else {
  App.Boot.populateVersionBadge();
}
