...
<!DOCTYPE html>
<!--
  dashboard-v7.4.0.2.html
  Source-editable dashboard file for the ESP32-C3 Multi-Sensor Gateway v7.4.0.2.
...
<body>
  ...
  <div class="about-bar">
    ...
    CSV export and import, storage statistics, and ESP management &mdash; all served from the device. v7.4.0.2
