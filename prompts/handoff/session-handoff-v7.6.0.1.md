...
### LESSON-OPS-092 — NVS seeding on first boot is not automatic
...
### LESSON-OPS-093 — All-or-nothing load semantics for NVS arrays
...
### LESSON-OPS-094 — Boot-time init vs runtime mutation mutex ordering
