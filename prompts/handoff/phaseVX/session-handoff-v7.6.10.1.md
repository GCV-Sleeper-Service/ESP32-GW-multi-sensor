...
_Date: 2026-04-22 | Updated: 2026-05-05 (IP addresses and board names corrected)_
...
ESPHome 2026.4.1 is the verified build environment. All 3 existing boards (C3, WROOM, S3) compile and pass stress tests (stack OK; heap limits documented in BUG-084). The local component override (16 KB httpd stack) is confirmed active.
...
| Board | board_id | Chip | SRAM | PSRAM | Flash | IP | esphome_board |
|---|---|---|---|---|---|---|---|
| ESP32-S3 SuperMini | `esp32-s3-supermini-4m` | ESP32-S3 | 512 KB | 2 MB (quad) | 4 MB | 192.168.120.173 | `esp32-s3-devkitc-1` |
| ESP32-C6 SuperMini | `esp32-c6-supermini-4m` | ESP32-C6 | 512 KB | None | 4 MB | 192.168.120.184 | `esp32-c6-devkitm-1` |
| ESP32-C5-WROOM-1U | `esp32-c5-wroom1u-8m` | ESP32-C5 | 384 KB | 8 MB (quad) | 8 MB | 192.168.120.180 | `esp32-c5-devkitc-1` |

### Board-specific notes

**ESP32-S3 SuperMini (sat-s3-4m-173):**
...
**ESP32-C6 SuperMini (sat-c6-4m-184):**
...
- ⚠️ Placeholder YAML had name typo `sat-c6-6m-1` — corrected to `sat-c6-4m-184` in board profile

**ESP32-C5-WROOM-1U MCN8R8 (sat-c5-8m-180):**
...
Version bumps trigger pipeline regeneration of ~20+ generated files. This is expected
behavior when `render_sensor_config.py` VERSION changes. See LESSON-OPS-129.
...
- Stress test script needs BUG-084 fixes before running on new boards
