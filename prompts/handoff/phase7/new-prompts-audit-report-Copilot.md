...
| 9 | `development-process-guide.md` §4.1 Assumption Audit Gate was bypassed | Meta-prompt updated: explicit §4.1 cited in mandatory reading list | **Fully** | `phase7-batch-production-prompt-update.md` l.69: "§4.1 (Assumption Audit Gate)" |
...
_Line numbers verified against commit `118e3d2`; section anchors are stable, line numbers may shift after later edits._
