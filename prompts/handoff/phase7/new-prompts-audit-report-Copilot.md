...
| **Deliverables section numbering** | "10-section agent prompt (§1-§11)" — inconsistency (11 sections listed, called 10) | Updated to "(§1-§10)" in Prompt Anatomy list, but Deliverables Per Step header still implicitly references old numbering | Minor inconsistency remains (l.155) |
