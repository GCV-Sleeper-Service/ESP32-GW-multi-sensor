...
check_contains "gateway_manifest_h_pragma_once" src/gateway_manifest.h "#pragma once"
check_contains "gateway_manifest_h_raw_string" src/gateway_manifest.h 'R"MANIFEST('
