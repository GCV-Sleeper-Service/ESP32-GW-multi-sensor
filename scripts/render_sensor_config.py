...
def generate_gateway_manifest_header(sensors: List[Dict[str, str]], version: str) -> str:
    """Generate gateway_manifest.h containing the v2 manifest as a C string literal."""
    manifest_dict = manifest_v2(sensors, f"v{version}")
...
def main() -> int:
    ...
    expected_gateway_manifest_h = generate_gateway_manifest_header(sensors, VERSION)
